        ...
        @method('PUT')
         ...
         <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Age:</strong>
                    <input type="text" name="age" value="{{ $employee->age }}" class="form-control" placeholder="age">
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <label><input type="radio" name="gender" id="" value="male" {{($employee->gender=="male")?"checked":""}}>Male</label>
                    <label><input type="radio" name="gender" id="" value="female" {{($employee->gender=="female")?"checked":""}}>Female</label>
                    <label><input type="radio" name="gender" id="" value="other" {{($employee->gender=="other")?"checked":""}}>Other</label>
                </div>
            </div>
